  ...
  return (
    <footer className="mt-20" style={{ background: 'linear-gradient(135deg, #0c1c2e 0%, #16324F 60%, #294f72 100%)' }}>
      <div className="max-w-[1400px] mx-auto px-6 py-12 grid grid-cols-1 sm:grid-cols-3 gap-10">
        ...
        <div>
          <h3 className="font-diocesan font-bold text-white mb-3 text-xl">{settings?.organisationName || 'Diocese of Baguio Schools'}</h3>
          <p className="text-sm text-white/70 leading-relaxed">
            {settings?.footerTagline || 'The Catholic schools of the Diocese of Baguio, serving Baguio City and the province of Benguet.'}
          </p>
        </div>
