...
export default defineType({
  ...
  fields: [
    ...
    defineField({ name: 'checklistIntro', title: 'Document Checklist Intro', type: 'text', rows: 3, initialValue: 'Gather the following documents in advance. Your selected school may request additional requirements.' }),
    defineField({ name: 'formEyebrow', title: 'Inquiry Form Label', type: 'string', initialValue: 'Start your application' }),
    defineField({ name: 'guidanceSchoolTitle', title: 'Guidance: School Heading', type: 'string', initialValue: 'Choose a preferred school' }),
